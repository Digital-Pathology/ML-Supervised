...
def coatnet_0():
    ...
    return CoAtNet((512, 512), 3, num_blocks, channels, num_classes=NUM_CLASSES)
...
if __name__ == '__main__':
    ...
    versions = [coatnet_0, coatnet_1, coatnet_2, coatnet_3, coatnet_4]
    ...
    dataset = Dataset(
        data="/workspaces/dev-container/testing/data/whole_slide_images/train",
        labels=LabelManager(
            path="/workspaces/dev-container/testing/data/whole_slide_images/train",
        ...
        filtration_cache="/workspaces/dev-container/ML-Unsupervised/filtration_cache.h5",
